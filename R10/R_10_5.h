...
class R_10_5
    : public RecursiveASTVisitor<R_10_5> {
public:
  explicit R_10_5 (ASTContext *Context) : Context(Context), err_msg ("The value of an expression should not be cast to an inappropriate essential type") {}
